<template>
  <div class="home-view">
    <!-- 左半部分 -->
    <div class="left">
      <div v-if="0" class="wrap special form-group-xs">
      ...
      <div v-if="0" class="wrap form-group-xs target">
        <div class="title flex">
    ...
    <div class="right">
      ...
      <quality-situation v-if="0" ></quality-situation>
      <div v-if="0" class="wrap white-bg wrap-tree">
